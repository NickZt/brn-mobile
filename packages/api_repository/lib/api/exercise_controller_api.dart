...
class ExerciseControllerApi {
  ...
  ExerciseControllerApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<BaseSingleObjectResponseDto> getExercisesByIDUsingGET(int exerciseId) async {
    ...
    String path = "/exercises/{exerciseId}".replaceAll("{format}","json").replaceAll("{" + "exerciseId" + "}", exerciseId.toString());
  ...
  Future<BaseResponseDto> getExercisesByIdsUsingPOST(ExerciseRequest body) async {
    ...
    // create path and map variables
    String path = "/exercises/byIds".replaceAll("{format}","json");
  ...
  Future<BaseResponseDto> getExercisesBySubGroupUsingGET(int subGroupId) async {
    ...
    // create path and map variables
    String path = "/exercises".replaceAll("{format}","json");

    // query params
    List<QueryParam> queryParams = [];
    Map<String, String> headerParams = {};
    Map<String, String> formParams = {};
      queryParams.addAll(_convertParametersForCollectionFormat("", "subGroupId", subGroupId));
